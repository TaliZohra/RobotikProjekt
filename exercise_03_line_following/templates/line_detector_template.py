...
class LineDetectorNode(Node):
    ...
    def image_callback(self, msg: Image):
        ...
        try:
            ...
            cv_image = self.bridge.imgmsg_to_cv2(msg, 'bgr8')  # TODO: Konvertieren
            ...
            gray = cv2.cvtColor(roi, cv2.COLOR_BGR2GRAY)  # TODO

            # Schritt 4: Schwellwert anwenden (weiße Linie = hell)
            # TODO: _, binary = cv2.threshold(...)
            _, binary = cv2.threshold(gray, self.threshold, 255, cv2.THRESH_BINARY)  # TODO
    ...
    def find_line_center(self, binary_image, image_width):
        ...
        moments = cv2.moments(binary_image)  # TODO
